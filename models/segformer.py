...
class SegFormerEncoderStage(nn.Sequential):
    ...
    This class gets several parameters and conducts encoder stage.

    Parameters:

        in_channels           - number of input channels in the input volume, int;
        out_channels          - number of output channels in the convolution layer, int;
        patch_size            - patch size, int;
        overlap_size          - overlap size, int;
        drop_probs            - dropout layer probabilities, list -> int;
        depth                 - depth of the block, int;
        reduction_ratio       - reduction ratio value, int;
        num_heads             - number of heads in the encoder, int;
        mlp_expansion         - mlp expansion ratio, int.
